...
class DateAndTimeFunctionsSpec extends ExprSuite {
  ...
  test("Epoch()") {
    ...
    val json = """{(epoch = NullL, unit = NullL)}"""
  ...
  test("TimeAdd()") {
    ...
    val json = """{(time_add = NullL, offset = NullL, unit = NullL)}"""
  ...
  test("TimeSubtract()") {
    ...
    val json = """{(time_subtract = NullL, offset = NullL, unit = NullL)}"""
  ...
  test("TimeDiff()") {
    ...
    val json = """{(time_diff = NullL, other = NullL, unit = NullL)}"""
